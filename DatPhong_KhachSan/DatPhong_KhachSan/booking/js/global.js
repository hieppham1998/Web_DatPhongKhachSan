(function ($) {
    ...
    try {
        ...
        $('#hiepstart').daterangepicker({
            ...
            $('#hiepstart').val(startDay.replace(/\//g, ' '));
            $('#hiepend').val(endDay.replace(/\//g, ' '));
        });
    
        $('#hiepstart-2').daterangepicker({
            ranges: true,
            autoApply: true,
            applyButtonClasses: false,
            autoUpdateInput: false
        },function (start, end) {
            $('#hiepstart-2').val(start.format('MM/DD/YYYY'));
            $('#hiepend-2').val(end.format('MM/DD/YYYY'));
        });
